...
## Overview
char-rnn is a **highly experimental** character-level text generation project using a Vanilla Recurrent Neural Network (RNN). The goal is to train the model to generate text character by character, exploring various configurations and understanding the limitations of simple RNNs.
